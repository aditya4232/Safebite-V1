...
const GrocerySchema = new mongoose.Schema({}, { collection: "Grocery Products", strict: false });
...
// API Products endpoint (for compatibility with existing frontend)
...
// Search endpoint for products (for compatibility with existing frontend)
